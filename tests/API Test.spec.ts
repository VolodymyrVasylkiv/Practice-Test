...
import users from "../project/api/usersResponse.json";
...
test("Reqres API GET", async ({ request }) => {
...
test("Reqres API PATCH", async ({ request }) => {
...
test("Mock route Reqres API Test 2", async ({ page }) => {
